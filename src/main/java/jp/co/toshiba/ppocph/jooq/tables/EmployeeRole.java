...
public class EmployeeRole extends TableImpl<EmployeeRoleRecord> {
    ...
    @Override
    public EmployeeRole as(Table<?> alias) {
        return new EmployeeRole(alias.getQualifiedName(), this);
    }
     ...
     */
    @Override
    public EmployeeRole rename(Table<?> name) {
        return new EmployeeRole(name.getQualifiedName(), null);
    }
