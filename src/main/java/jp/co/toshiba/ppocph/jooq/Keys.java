...
public class Keys {
    ...
    public static final UniqueKey<AuthoritiesRecord> NUNIQUES = Internal.createUniqueKey(Authorities.AUTHORITIES, DSL.name("nUniques"), new TableField[] { Authorities.AUTHORITIES.NAME }, true);
    public static final UniqueKey<AuthoritiesRecord> TUNIQUES = Internal.createUniqueKey(Authorities.AUTHORITIES, DSL.name("tUniques"), new TableField[] { Authorities.AUTHORITIES.TITLE }, true);
    ...
    public static final UniqueKey<RolesRecord> UT1 = Internal.createUniqueKey(Roles.ROLES, DSL.name("ut1"), new TableField[] { Roles.ROLES.NAME }, true);
    ...
    public static final ForeignKey<EmployeeRoleRecord, EmployeesRecord> EMPLOYEE_ROLE__FK1 = Internal.createForeignKey(EmployeeRole.EMPLOYEE_ROLE, DSL.name("fk1"), new TableField[] { EmployeeRole.EMPLOYEE_ROLE.EMPLOYEE_ID }, Keys.EMPLOYEE_PKEY, new TableField[] { Employees.EMPLOYEES.ID }, true);
    public static final ForeignKey<EmployeeRoleRecord, RolesRecord> EMPLOYEE_ROLE__FK2 = Internal.createForeignKey(EmployeeRole.EMPLOYEE_ROLE, DSL.name("fk2"), new TableField[] { EmployeeRole.EMPLOYEE_ROLE.ROLE_ID }, Keys.ROLE_PKEY, new TableField[] { Roles.ROLES.ID }, true);
    public static final ForeignKey<RoleAuthRecord, RolesRecord> ROLE_AUTH__FK3 = Internal.createForeignKey(RoleAuth.ROLE_AUTH, DSL.name("fk3"), new TableField[] { RoleAuth.ROLE_AUTH.ROLE_ID }, Keys.ROLE_PKEY, new TableField[] { Roles.ROLES.ID }, true);
    public static final ForeignKey<RoleAuthRecord, AuthoritiesRecord> ROLE_AUTH__FK4 = Internal.createForeignKey(RoleAuth.ROLE_AUTH, DSL.name("fk4"), new TableField[] { RoleAuth.ROLE_AUTH.AUTH_ID }, Keys.AUTH_PKEY, new TableField[] { Authorities.AUTHORITIES.ID }, true);
}
